...
class tela_progbar(QtWidgets.QMainWindow):

    def __init__(self):

        super(tela_progbar,self).__init__()
        self.lay_principal = QVBoxLayout()
        self.setGeometry(500, 500, 420, 200)
        self.setWindowTitle("Baixando Programa...")
        ...
        .QWidget {
            ...
            background-image: url(im/Splash_Kondor.png);
            }
        """)
        self.label1 = QLabel('')
